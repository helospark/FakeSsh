...
/**
 * State machine of the FakeSSH flow.
 * @author helospark
 */
public class SshStateMachine {
	...
	public SshStateMachine(List<SshCommonState> commonStates, List<SshState> states, SshIdentificationExchanger identificationExchanger, LoggerSupport loggerSupport, SshDataExchangeService dataExchangeService) {
