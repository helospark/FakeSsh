...
/**
 * Factory to create HMAC for 'hmac-md5' type.
 * @author helospark
 */
@Component
@Order(3)
public class Md5HmacFactory extends AbstractMessageDigestBasedHmacFactory {
	private static final String HMAC_ALGORITHM_SIGNATURE = "hmac-md5";
	private static final String MESSAGE_DIGEST_ALGORITM_NAME = "MD5";
	private static final int MD5_BLOCK_SIZE = 64;
	private static final int MD5_RESULT_SIZE = 16;
