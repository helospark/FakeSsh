...
import com.helospark.FakeSsh.hostkey.dsa.DsaServerHostKeyAlgorithm;
...
public class DsaKeyProviderTest {
	...
	private DsaServerHostKeyAlgorithm underTest;
	//
	//	@BeforeMethod
	//	public void setUp() throws Exception {
	//		initMocks(this);
	//		underTest = new DsaServerHostKeyAlgorithm("privateKeyName", base64PrivateKeyReader, loggerSupport, dssSignatureService);
	//		setThing();
	//	}
	//
	//	@Test
	...
	//
	//		// THEN
	//		assertEquals(underTest.sign(), dsaPrivateKey);
	//	}
	//
	//	@Test
	...
	//	}
	//
	//	private void setThing() throws Exception {
	//		byte[] decodedPrivateKey = Base64.getDecoder().decode("MIIBuwIBAAKBgQC1nDDS6AcHiIHj8AdaIAyyobXfRzJm6d48v5+KdAEB5t90jP8r" +
	...
	//		when(base64PrivateKeyReader.read("privateKeyName")).thenReturn(decodedPrivateKey);
	//	}
	//
